...
import com.handmark.pulltorefresh.library.internal.CycleLoadingLayout;
import com.handmark.pulltorefresh.library.internal.FlipLoadingLayout;
import com.handmark.pulltorefresh.library.internal.HeartLoadingLayout;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	private boolean mHasPullUpFriction = true; // false 设置没有上拉阻力  true  设置上拉阻力
	private boolean mHasPullDownFriction = true;// false 设置没有下拉阻力  true  设置下拉阻力
	...
	public boolean canAutoLoad = true;//是否执行自动加载
	public int mLastTotalItemCount = 0;//自动加载前的Item总数
	...
	/** 刷新完成相关处理 */
	public abstract void handleRefreshComplete( );
	...
	public OnRefreshListener<T> getOnRefreshListener( )
	{
	...
	public final void setRefreshing() {
		setRefreshing(true, Mode.PULL_FROM_START);
	}
	...
	@Override
	public final void setRefreshing(boolean doScroll, Mode refreshMode){
		if (!isRefreshing()) {
	...
	public enum AnimationStyle {
		...
		LoadingLayoutBase createLoadingLayout(Context context, Mode mode, Orientation scrollDirection, TypedArray attrs) {
			AnimationStyle animationStyle = getDefault( );
			...
			switch (animationStyle) {
				...
				case HEART:
					return new HeartLoadingLayout(context, mode, scrollDirection, attrs);
				case CYCLE:
					return new CycleLoadingLayout( context , mode , scrollDirection , attrs );
			}
		}
	}
