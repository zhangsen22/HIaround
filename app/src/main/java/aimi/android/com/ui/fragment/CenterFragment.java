...
import aimi.android.com.presenter.CenterPresenter;
...
import aimi.android.com.ui.activity.IdentityActivity;
...
import aimi.android.com.ui.activity.RecommendToFriendsActivity;
import aimi.android.com.ui.widget.KeFuPopupView;
...
public class CenterFragment extends BaseFragment implements CenterContract.View {
    ...
    @BindView(R.id.ll_zijinmima)
    LinearLayout llZijinmima;
    ...
    @OnClick({R.id.iv_edit, R.id.ll_shenfencard, R.id.ll_add_sk_type, R.id.ll_tj_friend, R.id.ll_lx_kf, R.id.ll_center_message, R.id.tv_logout,R.id.ll_zijinmima})
