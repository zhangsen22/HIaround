...
public class MediaGridFragment extends BaseFragment implements MediaGridView, RecyclerViewFinal.OnLoadMoreListener,
    ...
    private void radioNext(MediaBean mediaBean) {
        ...
        Logger.i("mediaBean :" + "mediaBean.getWidth(): " + mediaBean.getWidth() + ",  mediaBean.getHeight(): " + mediaBean.getHeight());
        if (mediaBean.getWidth() < 600 || mediaBean.getHeight() < 600) {
            ToastUtils.toastMsg(getContext(),R.string.gallery_pic_too_small);
            return;
        }
